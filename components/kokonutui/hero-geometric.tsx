    ...
    <div className="relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-[#030303]">
      ...
      <div className="relative z-10 container mx-auto px-4 md:px-6">
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            <span className="text-sm text-cyan-400 tracking-wide">Available for hire</span>
          </motion.div>
          ...
          <motion.div custom={1} variants={fadeUpVariants} initial="hidden" animate="visible">
            <h1 className="text-4xl sm:text-6xl md:text-8xl font-bold mb-6 md:mb-8 tracking-tight">
              ...
              <span
                className={cn(
                  "bg-clip-text text-transparent bg-gradient-to-r from-cyan-300 via-white/90 to-purple-300",
                  pacifico.className,
                )}
              >
                {name}
          ...
          >
            {[
              ...
              <motion.div key={i} custom={i} variants={socialVariants} initial="hidden" animate="visible">
                <Link
                  href={social.href}
                  className="text-white/60 hover:text-cyan-400 transition-colors transform hover:scale-110 inline-block"
                >
                  {social.icon}
                </Link>
              </motion.div>
